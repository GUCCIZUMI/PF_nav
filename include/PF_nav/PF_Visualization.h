...
private:
    ...
    std::vector<double> robot_distances_; //範囲内マーカーのロボットとマーカー距離
    ...
    double radius_ = 8.0, start_angle_ = 0.0, end_angle_ = 0.0, angle_area_ = 85.2 * M_PI / 180; //ロボットの観測範囲の定義
    //double dis_var_ = 0.2, ang_var_ = 0.2; //お試し尤度関数の分散値(距離、角度)
